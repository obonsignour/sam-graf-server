...
def Leiden_Call_Graph(application, graph_id, graph_type, linkTypes=["all"]):
    model = "Leiden"
    ...
    if G.vcount() == 0:
        print(f"The neo4j {graph_type} graph {graph_id} is Object/SubOject node empty.")
        return
    
    # Print the number of nodes
    print(f"The neo4j {graph_type} graph {graph_id} has {G.vcount()} Object/SubOject nodes.")
...
if __name__ == "__main__":
    ...
    Leiden_Call_Graph(application, graph_id, graph_type, linkTypes)
