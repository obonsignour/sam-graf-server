...
def Directed_Louvain_Call_Graph(application, graph_id, graph_type, linkTypes=["all"]):
    ...
    dendrogram, hierarchy_tree = community_detection_hierarchy(G, level=1)
...
if __name__ == "__main__":
    ...
    print(f"Execution time for the DirectedLouvain Algorithm on the neo4j {graph_type} graph {graph_id}: {elapsed_time} seconds")